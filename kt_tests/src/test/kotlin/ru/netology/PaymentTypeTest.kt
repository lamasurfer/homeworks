...
internal class PaymentTypeTest {
    ...
    @Test
    fun test_processPayment_Mastercard_underLimit_returnsZeroFee() {
        val limit = 75000_00L
    ...
    @Test
    fun test_processPayment_Maestro_underLimit_returnsZeroFee() {
        val limit = 75000_00L
        val previousAmount = limit - 1L
        val currentAmount = 5000_00L
        val expected = 0L
    ...
    @Test
    fun test_processPayment_VKPay_returnsZeroFee() {
        val previousAmount = Random.nextLong()
        val currentAmount = 5000_00L
        val expected = 0L
